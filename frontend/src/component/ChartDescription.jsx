        ...
        <div className="max-w-lg mx-auto mt-8 p-4 bg-white shadow-lg rounded-lg">
            ...
            <div className="flex border-b border-gray-300 mb-4">
                {skills.map((skill, index) => (
                    <button
                        key={index}
                        className={`flex-1 py-2 text-center cursor-pointer ${activeTab === index ? 'border-b-4 border-green-500 text-green-500' : 'text-gray-500'}`}
            ...
            {/* Tab Content */}
            <div className="p-4">
                <h3 className="text-xl font-semibold text-green-600">{skills[activeTab].subject}</h3>
